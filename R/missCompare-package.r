...
#' sophisticated missing data imputation algorithms and compares them assuming custom set missingess patterns.
#' missCompare will give you a comparative analysis of missing data imputation algorithms, offer a report with
#' the best performing algorithms assuming various missing data patterns and publication ready visualizations,
#' impute your dataset for you, assess imputation performance using a validation framwork and help you better
#' understand missing data in your dataset.
#'
#' @details
#' \tabular{ll}{
