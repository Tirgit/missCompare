...
#' \item{MCAR_MAE}{Mean absolute error (MAE) between the indexed original values and the imputed values in an MCAR missingess pattern (default output)}
#' \item{MAR_MAE}{Mean absolute error (MAE) between the indexed original values and the imputed values in an MAR missingess pattern (default output)}
#' \item{MNAR_MAE}{Mean absolute error (MAE) between the indexed original values and the imputed values in an MNAR missingess pattern (default output)}
#' \item{MAP_MAE}{Mean absolute error (MAE) between the indexed original values and the imputed values in an MAP missingess pattern (optional output)}
#' \item{MCAR_KS}{Kolmogorov–Smirnov test statistic (KS) between the indexed original values and the imputed values in an MCAR missingess pattern (default output)}
#' \item{MAR_KS}{Kolmogorov–Smirnov test statistic (KS) between the indexed original values and the imputed values in an MAR missingess pattern (default output)}
#' \item{MNAR_KS}{Kolmogorov–Smirnov test statistic (KS) between the indexed original values and the imputed values in an MNAR missingess pattern (default output)}
#' \item{MAP_KS}{Kolmogorov–Smirnov test statistic (KS) between the indexed original values and the imputed values in an MAP missingess pattern (optional output)}
#'
#' @examples
#' \dontrun{
