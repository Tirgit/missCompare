...
#'
#' @description
#' \code{\link{test_mice_mixed}} tests the imputation accuracy of the mice mixed missing data imputation algorithm on matrices with various missing data patterns
#'
#' @details
...
test_mice_mixed <- function(X_hat, list) {
    ...
    log_output <- utils::capture.output(results <- lapply(list, mice_mixed_imp))
...
# y$Fraction_missingness_per_variable) test_mice_mixed(X_hat = yy$Simulated_matrix,
# list = res)
