#################################################################################################################################################
#
#The purpose of this function is impute missing datapoints using missForest imputation
...
dimple_aregImpute_imp <- function(X_hat, list) {
  ...
  results <- lapply(list, aregImpute_imp)
