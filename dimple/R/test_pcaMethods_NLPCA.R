#################################################################################################################################################
#
#The purpose of this function is impute missing datapoints using the pcaMethods NLPCA imputation
...
#test_pcaMethods_NLPCA(X_hat = yy$Simulated_matrix, list = res)
