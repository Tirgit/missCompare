...
imp_wrapper <- function(rownum, colnum, cormat, missfrac_per_var, n.iter = 10, assumed_pattern = NA) {
  ...
  for (i in 1:n.iter) {
    ...
    collect_res[((16*(i-1))+1),2:ncol(collect_res)] <- as.data.frame(test_random_imp(sim$Simulated_matrix, list = res))
    collect_res[((16*(i-1))+2),2:ncol(collect_res)] <- as.data.frame(test_median_imp(sim$Simulated_matrix, list = res))
    collect_res[((16*(i-1))+3),2:ncol(collect_res)] <- as.data.frame(test_mean_imp(sim$Simulated_matrix, list = res))
    collect_res[((16*(i-1))+4),2:ncol(collect_res)] <- as.data.frame(test_missMDA_regularized(sim$Simulated_matrix, list = res))
    collect_res[((16*(i-1))+5),2:ncol(collect_res)] <- as.data.frame(test_missMDA_EM(sim$Simulated_matrix, list = res))
    collect_res[((16*(i-1))+6),2:ncol(collect_res)] <- as.data.frame(test_pcaMethods_PPCA(sim$Simulated_matrix, list = res))
    collect_res[((16*(i-1))+7),2:ncol(collect_res)] <- as.data.frame(test_pcaMethods_svdImpute(sim$Simulated_matrix, list = res))
    collect_res[((16*(i-1))+8),2:ncol(collect_res)] <- as.data.frame(test_pcaMethods_BPCA(sim$Simulated_matrix, list = res))
    collect_res[((16*(i-1))+9),2:ncol(collect_res)] <- as.data.frame(test_pcaMethods_Nipals(sim$Simulated_matrix, list = res))
    collect_res[((16*(i-1))+10),2:ncol(collect_res)] <- as.data.frame(test_pcaMethods_NLPCA(sim$Simulated_matrix, list = res))
    collect_res[((16*(i-1))+11),2:ncol(collect_res)] <- as.data.frame(test_mice_mixed(sim$Simulated_matrix, list = res))
    collect_res[((16*(i-1))+12),2:ncol(collect_res)] <- as.data.frame(test_mi(sim$Simulated_matrix, list = res))
    collect_res[((16*(i-1))+13),2:ncol(collect_res)] <- as.data.frame(test_AmeliaII(sim$Simulated_matrix, list = res))
    collect_res[((16*(i-1))+14),2:ncol(collect_res)] <- as.data.frame(test_missForest(sim$Simulated_matrix, list = res))
    collect_res[((16*(i-1))+15),2:ncol(collect_res)] <- as.data.frame(test_aregImpute(sim$Simulated_matrix, list = res))
    collect_res[((16*(i-1))+16),2:ncol(collect_res)] <- as.data.frame(test_kNN(sim$Simulated_matrix, list = res))
