...
<img src="../man/figures/Plot_TIME.png" alt="Upside-down sloths are so cute", width = "100%">


## RMSE comparison
<img src="../man/figures/Plot_RMSE.png" alt="Upside-down sloths are so cute", width = "100%">


## MAE comparison
<img src="../man/figures/Plot_MAE.png" alt="Upside-down sloths are so cute", width = "100%">


## KS comparison
<img src="../man/figures/Plot_KS.png" alt="Upside-down sloths are so cute", width = "100%">
