...
```{r eval = FALSE} 
missCompare::MCAR(X_hat = simulated$Simulated_matrix,
...
```{r eval = FALSE} 
missCompare::MAR(X_hat = simulated$Simulated_matrix,
                  missfrac_per_var = metadata$Fraction_missingness_per_variable,
                  window = 0.5)

missCompare::MNAR(X_hat = simulated$Simulated_matrix,
                  missfrac_per_var = metadata$Fraction_missingness_per_variable,
                  window = 0.5)
```
...
```{r eval = FALSE} 
missCompare::MAP(X_hat = simulated$Simulated_matrix,
                  missfrac_per_var = metadata$Fraction_missingness_per_variable,
